package com.mrikso.player.dtpv.youtube.views;
 ...
 *
 * <p>Since it's based on view's alpha the fading effect is more fluid (more YouTube-like) than
 * using static drawables, especially when [cycleDuration] is low.
 *
 * <p>Used by [YouTubeOverlay][com.github.vkay94.dtpv.youtube.YouTubeOverlay].
 */
public final class SecondsView extends ConstraintLayout {
    ...
    public SecondsView(@NonNull Context context, @Nullable AttributeSet attrs) {
        ...
        thirdAnimator = new CustomValueAnimator(
                ...
                new Consumer<Float>() {
                    @Override
                    public void accept(Float aFloat) {
                        findViewById(R.id.icon_1)
                                .setAlpha(1f - findViewById(R.id.icon_3).getAlpha());
    ...
    /**
     * Defines the duration for a full cycle of the triangle animation. Each animation step takes
     * 20% of it.
     */
    ...
    public final void setSeconds(int value) {
        ...
        textView.setText(getContext().getResources().getQuantityString(R.plurals.quick_seek_x_second, value, value));
        seconds = value;
    }
