package com.mrikso.player.dtpv;
...
public interface PlayerDoubleTapListener {
    ...
    /**
     * Called for each ongoing tap (also single tap) (MotionEvent#ACTION_DOWN) when double tap
     * started and still in double tap mode defined by {@link DoubleTapPlayerView#doubleTapDelay}
     *
     * @param posX x tap position on the root view
     * @param posY y tap position on the root view
     */
    ...
    /**
     * Called for each ongoing tap (also single tap) (MotionEvent#ACTION_UP} when double tap started
     * and still in double tap mode defined by {@link DoubleTapPlayerView#doubleTapDelay}
     *
     * @param posX x tap position on the root view
     * @param posY y tap position on the root view
     */
