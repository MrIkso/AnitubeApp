...
public class ApiClient {
    ...
    public static final String BASE_URL = "https://anitube.biz";
    public static final String RANDOM_ANIME_URl = BASE_URL + "/?do=random_anime";
    public static final String PROFILE_BG_URL = "https://anitube.biz/templates/smartphone/images/profile_bg.jpg";
    public static final String ANIME_CAROUSEL_BG_URL =
            "https://anitube.biz/templates/AniTubenew/images/images/slider/slayd2.png";
