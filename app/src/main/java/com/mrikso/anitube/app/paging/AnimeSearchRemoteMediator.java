...
public class AnimeSearchRemoteMediator extends RxRemoteMediator<Integer, AnimeReleaseModel> {
    ...
    public AnimeSearchRemoteMediator(
            AnitubeApiService service,
    ...
    private AnimeRemoteKeys getRemoteKeyClosestToCurrentPosition(
        ...
        if (position != null) {
            ...
            if (closesAnime != null) {
                return database.animeRemoteKeysDao().remoteKeysByAnimeId(closesAnime.getAnimeId());
            }
        }
        return null;
    }
