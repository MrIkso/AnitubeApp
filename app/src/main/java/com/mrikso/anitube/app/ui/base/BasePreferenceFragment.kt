package com.mrikso.anitube.app.ui.base

import com.mrikso.anitube.app.R
import com.mrikso.anitube.app.databinding.DialogTextPreferenceBinding
...
abstract class BasePreferenceFragment : PreferenceFragmentCompat() {
   // abstract val titleResourceId: Int
    ...
    override fun onStart() {
        super.onStart()
        //(activity as? MainActivity)?.changeTopBarText(getString(titleResourceId))
    }
